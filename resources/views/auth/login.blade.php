...
<div class="container" style="height: auto;">
  <div class="row align-items-center">
    <div class="col-md-9 ml-auto mr-auto mb-3 text-center">
      <h3>{{ __('Logeate con tu cuenta de usuario , si no cuentas con una puedes puedes comunicarte con soporte tecnico') }} </h3>
    </div>
          ...
          <div class="card-body">
            ...
            <div class="form-check mr-auto ml-3 mt-3">
              <label class="form-check-label">
                <input class="form-check-input" type="checkbox" name="remember" {{ old('Recuerdame') ? 'checked' : '' }}> {{ __('Remember me') }}
